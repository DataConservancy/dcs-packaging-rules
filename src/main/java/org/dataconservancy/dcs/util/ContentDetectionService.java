...
public class ContentDetectionService {
     ...
     * @return {@link List} of {@link org.dataconservancy.dcs.model.DetectedFormat}s for the provided file.
     */
     ...
     * @return A {@link List} of {@link org.dataconservancy.dcs.model.DetectedFormat}s found that match the file name.
     ...
     * @return {@link List} of possible formats for the given file extension, or null if no formats are found.
     */
