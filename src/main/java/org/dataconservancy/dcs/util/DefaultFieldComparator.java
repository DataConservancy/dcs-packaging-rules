...
public class DefaultFieldComparator implements Comparator<Field> {
    ...
    /**
     * Compares two fields for equality: fields must be in the same {@link Field#getDeclaringClass() declaring class},
     * have the same {@link Field#getName() name}, and have the same {@link Field#getType() type} to be
     * considered equal.
     * <p>
