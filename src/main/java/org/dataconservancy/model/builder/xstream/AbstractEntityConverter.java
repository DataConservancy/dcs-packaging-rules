 ...
 * such as nullity checks, XML namespace declarations, and {@link QName} handling.  All Data Conservancy
...
public abstract class AbstractEntityConverter implements Converter {
     ...
     * {@link NsAwareStream#getQname()} is called, and the local part of the {@link QName}
    ...
    /**
     * Returns the current element as a {@link QName}.
     *
     * If {@code reader} implements {@link NsAwareStream},
